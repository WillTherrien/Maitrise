...
wb = xlsxwriter.Workbook('/home/ubuntu/catkin_ws/src/research_racecar/bagfiles/data_excel/limo_sigma_FULL_1000.xlsx')
...
for bagFile in listOfBagFiles:
    ...
    width = 0.28
    f_length = 0.93   # valeur fictive
    b_length = 0.13  # valeur fictive
    g = 9.81
